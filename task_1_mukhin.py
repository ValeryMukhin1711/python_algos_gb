...
def check_1(lst_obj):
    ...
    Сложность: !!!.
    """
    lst_to_set = set(lst_obj)  # !!! - линейная сложность
...
def check_2(lst_obj):
    ...
    Сложность: !!!.
    """
    for j in range(len(lst_obj)):          # !!! - линейная сложность алгоритма
        if lst_obj[j] in lst_obj[j+1:]:    # !!! - квадратичная
            return False                   # !!! - линейная сложность
    return True                            # !!! - линейная сложность
...
def check_3(lst_obj):
    ...
    Сложность: !!!
    """
    lst_copy = list(lst_obj)                 # !!! - линейная сложность
    lst_copy.sort()                          # !!! - линейно-логарифмическая сложность
    for i in range(len(lst_obj) - 1):        # !!! - линейная сложность
        if lst_copy[i] == lst_copy[i+1]:     # !!! - квадратичная сложность
            return False                     # !!! - линейная сложность
    return True                              # !!! - линейная сложность
